...
def DataQualityAssessment(data):
    ...
    dataQuality = pd.concat(
        [AD_result['is_anomaly'], AD_result['anomaly_score'],
         DD_result['is_duplicate'], DD_result['found_matches'],
         data._df['observedAt']
         ], axis=1)
    ...
    entity = {
        ...
        "duplicate": {
            ...
            "value": {
                "isDuplicate": {
                    "type": "Property",
                    "value": bool(data['is_duplicate'])
                },
                "foundMatches": {
                    "type": "Property",
                    "value": data['found_matches']
                }
            },
            "observedAt": date
        },
